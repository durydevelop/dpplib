...
bool DStringGrid::SetRow(size_t Index, std::vector<std::string> &Items)
{
	...
	// Riga da modificare
	vector<string> &CurrRow=Grid.at(Index);
...
bool DStringGrid::SaveToCsvFile(string Filename, char StringSeparator)
{
