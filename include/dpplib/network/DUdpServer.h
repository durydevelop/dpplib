...
struct DUdpSession : std::enable_shared_from_this<DUdpSession> {
    ...
    void handle_request(const boost::system::error_code& ec, std::size_t BytesRecvd);
    void handle_sent(const boost::system::error_code& ec, std::size_t BytesSent);
...
class DUdpServer
{
    public:
        ...
        DUdpServer(boost::asio::io_service& io_service);
        void Run();
    ...
    private:
        ...
        void handle_receive(shared_session session, const boost::system::error_code& ec, std::size_t bytes_recvd);
        void PostResponse(shared_session const& session, size_t len);
        void handle_response(shared_session session, const boost::system::error_code& ec, std::size_t BytesRecvd);
