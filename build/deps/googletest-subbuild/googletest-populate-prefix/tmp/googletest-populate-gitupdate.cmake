...
execute_process(
  COMMAND "C:/msys64/usr/bin/git.exe" show-ref "master"
  WORKING_DIRECTORY "E:/Programming/Lib/cpp/libdpp/build/deps/googletest-src"
...
# yet).
execute_process(
  COMMAND "C:/msys64/usr/bin/git.exe" rev-list --max-count=1 "${git_tag}"
  WORKING_DIRECTORY "E:/Programming/Lib/cpp/libdpp/build/deps/googletest-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      execute_process(
        COMMAND "C:/msys64/usr/bin/git.exe" checkout "${git_remote}/${git_tag}"
        WORKING_DIRECTORY "E:/Programming/Lib/cpp/libdpp/build/deps/googletest-src"
        RESULT_VARIABLE error_code
        )
      if(error_code)
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'E:/Programming/Lib/cpp/libdpp/build/deps/googletest-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/Programming/Lib/cpp/libdpp/build/deps/googletest-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
    ...
    execute_process(
      COMMAND "C:/msys64/usr/bin/git.exe" checkout "${git_tag}"
      WORKING_DIRECTORY "E:/Programming/Lib/cpp/libdpp/build/deps/googletest-src"
      RESULT_VARIABLE error_code
      )
    if(error_code)
